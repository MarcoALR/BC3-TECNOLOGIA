  ...
  return (
    <section id="sobre" className="py-16 sm:py-24 section-dark relative overflow-hidden" ref={ref}>
      ...
      <div className="container mx-auto px-3 sm:px-4 lg:px-8 relative z-10">
        ...
        >
          {stats.map((stat) => (
            <div key={stat.label} className="text-center p-4 sm:p-6 rounded-2xl bg-secondary/30 border border-secondary-foreground/10">
        ...
        <div className="grid lg:grid-cols-2 gap-10 sm:gap-16 items-center mb-12 sm:mb-20">
          ...
          >
            {differentials.map((diff) => (
              <div key={diff.title} className="p-4 sm:p-6 rounded-2xl bg-secondary/30 border border-secondary-foreground/10 hover:border-primary/30 transition-all duration-300 group">
